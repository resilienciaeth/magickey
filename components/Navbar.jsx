      ...
      <div className="flex font-creato justify-between items-center nm:h-24 h-14  px-4 bg-[#121212] text-black">
        ...
        <ul className="hidden text-white font-bold nm:flex nm:mr-10 space-x-[4rem] text-[15px]">
          ...
          <div
            onClick={() =>
              window.open(
                "https://twitter.com/hashtag/DEBOOKinpublic?src=hashtag_click"
              )
            }
            className="flex flex-row items-center px-2 cursor-pointer rounded-2xl hover:bg-zinc-900 duration-[600ms]"
          >
            <AiOutlineBell size={30} />
            <li className="p-2 ">Live Updates</li>
         ...
         w-[100px] flex-col drop-shadow-lg"
            >
              ...
              <a
                ...
                href="#"
                onClick={() =>
                  window.open("https://www.instagram.com/debook.app")
                }
              >
                Instagram
              </a>
        ...
        <div
          className={
            !nav
              ? "fixed bg-white left-0 top-0 w-full z-10 h-full bg-beyond-1 ease-in-out duration-500"
              : "fixed left-[-100%]"
          }
        >
          <div
            ...
            role="presentation"
            className="mt-10 px-6 cursor-pointer"
          >
            <CldImage
              alt="logo"
              src="v1672097966/logo_nex9ig.png"
          ...
          <ul className="pt-16 px-10 uppercase font-bold">
            ...
            <button
              onClick={() => window.open("/mint", "_self")}
              className="uppercase text-[12px] nm:text-[30px] border-black border-2 rounded-[6px] ml-2 mt-4 px-4 py-1 hover:bg-black hover:text-white hover:border-white"
            >
              BUY MAGICKEY
            </button>
          </ul>

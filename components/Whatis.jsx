    ...
    <div className="h-[120vh] nm:h-[100vh] bg-black px-10">
      <div className="nm:mt-20">
        ...
        <div className="h-[90vh] nm:px-20 space-y-4 nm:space-y-0 nm:space-x-14 flex flex-col nm:flex-row mt-10">
          <div className=" orange-1 h-[33%] nm:h-[40vh] nm:w-[33%]  rounded-xl flex items-center justify-start flex-col">
            <h1 className="mt-10 nm:mt-16 text-[20px] md:text-[24px] text-white text-center font-bold leading-[30px]">
              A book is a book
              <br />
              {' '}

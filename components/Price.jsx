    ...
    <div className="bg-black nm:mt-32">
      <div className="nm:px-32">
        ...
        <p className="text-[12px] nm:text-[15px] px-6 text-center mt-6 text-magickey-2">
          Your DEBOOK Magickey is your passport to all the utilities above. Inspired by communities like FLOOR, Visualize Value or Veefriends.
          We will use all the knowledge acquired through those communities to make sure that Magickey makes you feel different.
        </p>
        <p className="text-[12px] nm:text-[15px] px-6 text-center mt-4 text-magickey-2">
        ...
        <div className="px-10 mt-6">
          <div className="bg-[#4F2B11] px-6 rounded-lg h-[50vh] nm:h-[17vh] nm:flex nm:flex-row nm:justify-around nm:items-center nm:space-x-32">
            <div className="flex flex-col ">
              <p className="text-white mt-10 nm:mt-0 text-[8px]">Price</p>
              <h1 className="magickey-4 text-[40px] font-bold">$150 USD</h1>
            </div>
            <div className="flex flex-row space-x-4 nm:space-x-20">
              <div className="flex flex-col">
                <p className="text-white mt-10 nm:mt-0  text-[8px]">Max Amount Per Wallet</p>
                <h1 className="magickey-4 text-[40px] font-bold">10</h1>
              </div>
              <div>
                <p className="text-white mt-10 nm:mt-0  text-[8px]">Total Amount of Magickeys</p>
                <h1 className="magickey-4 text-[40px] font-bold">3333</h1>
              </div>
            </div>
            <div>
              <p className="text-white mt-10 nm:mt-0  text-[8px]">Launch Day</p>

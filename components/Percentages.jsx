    ...
    <div className="bg-black px-10 mt-20 h-[110vh] nm:flex nm:flex-col nm:justify-center ">
      <div>
        ...
        <div className=" nm:h-auto space-y-4 nm:space-y-0 nm:space-x-10 mt-10 nm:flex nm:flex-row">
          <div className="grey-1 h-[30vh] nm:h-[30vh] nm:w-[33%] rounded-xl flex items-center justify-start nm:justify-center flex-col ">
            <h1 className="mt-10 nm:mt-0 text-[25px] nm:text-[30px] magickey-5 text-center font-bold leading-[30px]">
              30% to the Founders
            </h1>

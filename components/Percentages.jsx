...
function Percentages() {
  return (
    <div className=" py-10 px-10 nm:flex nm:flex-col ">
      <div>
        <h1 className="magickey-7 text-center text-[30px] nm:text-[70px] font-bold leading-[50px] nm:leading-[70px]">
        ...
        <div className=" nm:h-auto space-y-4 nm:space-y-0 nm:space-x-10 mt-10 nm:flex nm:flex-row">
          <div className="magickey-8 h-[60vh] nm:w-[33%] rounded-xl flex items-center justify-center flex-col ">
            ...
            <p className=" text-[#3D3D3D] text-[15px] nm:text-[18px] text-center px-4 mt-6">
              We plan to cover the costs of living as well as the investments already made on DEBOOK this way, so we can continue to devote our future to DEBOOK. We are doing this full time and your confidence will be our fuel to make sure DEBOOK goes mainstream.
            </p>
          </div>
          <div className="magickey-8 h-[60vh] nm:w-[33%] rounded-xl flex items-center justify-center flex-col ">
            <h1 className="text-[40px] nm:text-[60px] magickey-9 text-center font-bold ">
              ...
              {' '}
              <br />
              <span className="text-[30px]">to Communication.</span>
            </h1>
            <p className="text-[#3D3D3D] text-[15px] nm:text-[18px] text-center px-4 mt-6">
              We already have a team in place and will use this % to expand it. We plan to hire humans that help us outreach to as many writers and authors as possible. We plan to connect with passionate people from top companies that have been part of the revolution of industries such as music and film.
            </p>
          </div>
          <div className="magickey-8 h-[60vh] nm:w-[33%] rounded-xl flex items-center justify-center flex-col ">
            <h1 className="text-[40px] nm:text-[60px] magickey-9 text-center font-bold ">
              ...
              {' '}
              <br />
              <span className="text-[40px]">to expansion</span>
            </h1>
            <p className="text-[#3D3D3D] text-[15px] nm:text-[18px] text-center px-4 mt-6">

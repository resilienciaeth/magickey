...
function Limited() {
  return (
    <div className="h-screen flex flex-col nm:flex-row items-center justify-center px-10">
      <div className="card-1 px-4 rounded-2xl rounded-b-none nm:rounded-3xl nm:rounded-t-none nm:rounded-r-none nm:rounded-tr-none max-w-[412px] max-h-[520px]">
      ...
      <div className="border-2 border-[#9F6E42] border-t-0 rounded-2xl nm:rounded-3xl nm:border-l-0 rounded-t-none nm:border-t-2 nm:rounded-l-none nm:h-[496px] nm:flex nm:justify-center nm:items-center nm:px-10">
        <div className="py-4 space-y-6 px-2 text-[#9F8A81]">
          <p>We could go the traditional route and pitch DEBOOK to venture capitals but we want to do things differently. We are taking our first step to making this opportunity accessible to almost everyone as it is our priority to do this alongside a community of visionaries that are going to be part of the journey. </p>

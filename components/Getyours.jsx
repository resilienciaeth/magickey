...
function Getyours() {
  return (
    <div className=" h-[60vh] nm:h-[60vh] flex flex-col items-center justify-start nm:justify-center">
      <div className="flex flex-col items-center justify-start nm:justify-center">

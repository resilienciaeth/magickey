...
function Future() {
  return (
    <div className="h-[120vh] nm:h-[90vh]">
      <div className="nm:flex nm:flex-row-reverse ">
        <div className="flex mt-20 nm:mt-0 nm:w-[50%] items-center justify-center">
        ...
        <div className="px-10 nm:px-0 nm:ml-[4rem] nm:w-[50%] nm:flex nm:flex-col nm:justify-center">
          ...
          <p className="text-center nm:mt-4 nm:text-left text-[12px] nm:text-[15px] leading-[20px] text-[#9F8A81]">
          ...
          <p className="text-center nm:text-left text-[12px] nm:text-[15px] leading-[20px] mt-10 text-[#9F8A81]
"
          >
